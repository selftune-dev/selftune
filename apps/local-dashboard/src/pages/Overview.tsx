...
import { AlertCircleIcon, RefreshCwIcon, RocketIcon, LayersIcon, XIcon } from "lucide-react";
  ...
  return (
    <div className="mx-4 lg:mx-6 flex items-center gap-3 rounded-lg border border-primary/20 bg-primary/5 px-4 py-3">
      ...
      <p className="flex-1 text-xs text-muted-foreground">
        ...
        over any metric label's{" "}
        <span className="inline-flex items-center text-muted-foreground/50">
          <LayersIcon className="size-2.5 mx-0.5" />
        </span>{" "}
        icon for an explanation. Click proposals in the Evolution timeline to see detailed evidence.
      </p>
      <button
        type="button"
        onClick={dismiss}
